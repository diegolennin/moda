...
<html>
    <head>
        <title>LISTAR PROOVEDORES</title>
        <meta charset="utf-8" />
        ...
        <div id="page-wrapper">
            ...
            <header id="header">
                <div class="logo container">
                    <div>
                        <h1><a href="../index.jsp" id="logo">LISTAR PROOVEDORES</a></h1>
                    </div>
                </div>
            </header>
            ...
            <nav id="nav">
                ...
                <div style="float: right;">
                    ...
                    <a aling="left" class="dropdown-toggle" href="../reportes/ayuda.jsp?id=/pdf/lista-de-proveedores.pdf">
                            ...
                            <%
                                if (request.getParameter("enviar") != null) {
                                    ...
                                    out.print("  <tbody>");
                                                ...
                                                out.print("<td><iclass='hidden-phone'><i class='fa fa-question-circle'></i> Nombres</td>");
                                                ...
                                                while (rs.next()) {
                                                    ...
                                                    out.print("<td>");
                                                    out.print("<a href = 'modificar.jsp?id=" + rs.getString("ruc") + "' <button class='btn btn-primary btn-xs'><i class='fa fa-pencil'></i></button> </a>");
                                                    out.print("<a href = 'eliminar.jsp?id=" + rs.getString("ruc") + "' <button class='btn btn-danger btn-xs'><i class='fa fa-trash-o'></i></button></a>");
                                                    out.print("<a href = 'desactivo.jsp?id=" + rs.getString("ruc") + "' <button class='btn btn-danger btn-xs'><i class='fa fa-check'></i></button></a>");
                                                    out.print("<a href = 'activo.jsp?id=" + rs.getString("ruc") + "'<button class='btn btn-success btn-xs'><i class='fa fa-times'></i></button></a>");
                                                    out.print("</td>");
                                                    out.print("</tr>");
                                                }
                                                out.print("  </tbody>");
