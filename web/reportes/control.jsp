...
<header id="header">
  ...
  &nbsp;
    <a href="../admin/admin.jsp">&laquo; Inicio </a>
                                    <h3><i class="fa fa-angle-right"></i>INGRESOS TOTALES DE COMPRAS</h3>
                                    <div class="row mt">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-panel">
                                               <section id="main-content">
                <section class="wrapper">
                    <center><h3><i class="fa fa-list-alt"></i>BUSQUEDA POR FECHAS</h3></center>
                    <div class="row mt">

                        <div class="col-lg-12">
                            <div class="form-panel">
                                <form  id="mregistrop" name="listar" action="vingresos.jsp" method="POST">
