        ...
        <div id="page-wrapper">
            ...
            <header id="header">
                <div class="logo container">
                    <div>
                        <h1><a href="../index.jsp" id="logo">Buscar Producto</a></h1>
                    </div>
                </div>
            </header>
                    ...
                    <div class="col-md-9">
                        <div>
                            ...
                            <%                                if (request.getParameter("enviar") != null) {
                                    ...
                                    String consulta = "";
                                    if (dni.equals("0")) {
                                        consulta = "select p.*,pr.*,c.*,t.* from productos p,proveedor pr,categorias c,tallas t where c.idcategoria=p.catproducto and t.idtalla=p.talproducto and p.proproducto=pr.ruc and pr.ruc='" + ids + "' and  idproducto like '%" + buscar + "%'";
                                    } else {
                                        consulta = "select p.*,pr.*,c.*,t.* from productos p,proveedor pr,categorias c,tallas t where c.idcategoria=p.catproducto and t.idtalla=p.talproducto and p.proproducto=pr.ruc  and pr.ruc='" + ids + "' and nomproducto like '%" + buscar + "%'";
                                    ...
                                    ;
                                    while (rs.next()) {
                                        out.print("   <tr onclick=enviar('" + f + "','" + rs.getString("idproducto") + "','" + rs.getString("nomproducto") + "','" + rs.getString("precio") + "','" + rs.getString("maximo") + "')>");
