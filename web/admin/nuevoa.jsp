            ...
            <section id="main-content">
                <section class="wrapper">
                    ...
                    <br> <br><br> <%
                        ...
                        String tpersona = request.getParameter("perfil");
                    ...
                    <%
                            con.consulta("INSERT INTO personas(dni, tdocumento, nombres, apellidos, correo, telefono, celular,direccion, tpersona)VALUES ('" + dni + "', '" + tipo + "', '" + nombre + "', '" + apellido + "', '" + correo + "', '" + telefono + "', '" + celular + "','" + direccion + "', '" + tpersona + "');");
