    ...
    <head>
        ...
        <script language='JavaScript'>
            function enviar(codigo) {
                opener.document.forms['mproducto'].elements['txtbuscar'].value = codigo;
        ...
        <div id="page-wrapper">
            ...
            <div id="main-wrapper">
                <div id="main" class="container">
                    <div class="col-md-9">
                        <div>
                            <form  id="registro" name="registro" action="bproducto.jsp" method="POST">
                            ...
                            <%                                if (request.getParameter("enviar") != null) {
                                    ...
                                    ;
                                    while (rs.next()) {
                                        out.print("   <tr onclick=enviar('" + rs.getString("idproducto") + "')>");
