    ...
    <section class="content-header">
      <h1>
        ...
        <small>unimodaibarra@gmail.com</small>
            ...
            <section >
                <section class="">
                    <h3><i></i>Actualizar Imagen</h3>
                    <div >

                        <div >
                            <div class="form-panel">
                                <form  id="mregistrop" name="listar" action="listar.jsp?id=<% out.print(id); %>" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <%
                                        if (request.getParameter("buscar") != null) {
                                            ...
                                            String consulta = "";
                                            if (valor.equals("0")) {
                                                consulta = "select * from productos where idproducto like'%" + buscar + "%'";
                                            } else if (valor.equals("1")) {
                                                consulta = "select * from productos where nomproducto like'%" + buscar + "%'";
                                            }
                                            ...
                                            if (contador > 0) {
                                                ...
                                                out.print(" <h4><i class='fa fa-angle-right'></i> Pacientes Registrados</h4>");
                                                out.print("  <hr>");
                                                out.print(" <thead>");
                                                out.print("  <tr>");
                                                
                                                out.print("    <th><i class='fa fa-bullhorn'></i> Codigo</th>");
                                                out.print("    <th class='hidden-phone'><i class='fa fa-question-circle'></i> Nombres</th>");
                                                out.print("   <th><i class='fa fa-bookmark'></i> Detalle </th>");
                                                out.print("   <th><i class='fa fa-bookmark'></i> Precio </th>");
                                                out.print(" <th><i class=' fa fa-edit'></i> Estado</th>");
                                                ...
                                                while (rs.next()) {
                                                    ...
                                                    out.print("    <td class='hidden-phone'>" + rs.getString("nomproducto   ") + "</td>");
                                                    out.print("  <td>" + rs.getString("idvariedad") + "</td>");
                                                     out.print("  <td>" + rs.getString("preactual") + "</td>");
                                                    ...
                                                    out.print("    <td>");
                                                    out.print("  <a href = '../administracion/mregistro.jsp?id=" + rs.getString("dni") + "&&ni="+id+"' <button class='btn btn-primary btn-xs'><i class='fa fa-pencil'></i></button> </a>");
                                                    out.print("  <a href = '../procesos/aregistrop.jsp?id=" + rs.getString("dni") + "&&ni="+id+"' <button class='btn btn-success btn-xs'><i class='fa fa-check'></i></button></a>");
                                                    out.print("   <a href = '../procesos/elregistrop.jsp?id=" + rs.getString("dni") + "&&ni="+id+"' <button class='btn btn-danger btn-xs'><i class='fa fa-trash-o'></i></button></a>");
                                                    out.print("   <a href = '../procesos/eregistrop.jsp?id=" + rs.getString("dni") + "&&ni="+id+"'<button class='btn btn-danger btn-xs'><i class='fa fa-times'></i></button></a>");
                                                    out.print("   </td>");
                                                    out.print(" </tr>");
                                                }
                                                out.print("  </tbody>");
