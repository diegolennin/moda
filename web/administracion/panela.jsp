...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><a href="foto.jsp"><i class="fa fa-link"></i> <span>Foto</span></a></li>
                           <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="../administracion/nclientes.jsp">Nuevo Cliente</a></li>
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="../administracion/listarpro.jsp">Modificar Productos</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
        ...
        <span class="dropdown user user-menu"><a href="#" class="dropdown-toggle" data-toggle="dropdown">
