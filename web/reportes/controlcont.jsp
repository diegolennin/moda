  ...
  &nbsp;
    <a href="../admin/admin.jsp">&laquo; Inicio </a>
                                <section class="wrapper">
                                    <h3><i class="fa fa-angle-right"></i>CONSOLIDADO TOTAL</h3>
                                    <div class="row mt">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-panel">
                                               <section id="main-content">
                <section class="wrapper">
                    <center><h3><i class="fa fa-list-alt"></i>REPORTE</h3></center>
                   

                        <div class="col-lg-12" aling="center">
                            <div class="form-panel">
                                <form  id="mregistrop" name="listar" action="vcont.jsp" method="POST">
                                    
                                    <div class="form-group">
                                        <input type="date" class="form-control" id="from" name="from" placeholder="FECFA INICIO">
                                    </div>
                                    <div class="form-group">
                                        <input type="date" class="form-control" id="to" name="to" placeholder="FECHA FIN">
                                    </div>
                                    
                                    <button type="submit" class="btn btn-default btn-green" id="buscar" name="GENERAR">Buscar Registro</button>
                                </form>
                                <br>
