            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active"><a href="perfil.jsp"><i class="fa fa-link"></i> <span>perfil</span></a></li>
                            ...
                            <div class="form-panel">
                                ...
                                <form class="form-horizontal style-form" action="../procesos/subir.jsp" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Imagen de Perfil</label>
                                        <div class="col-sm-10">
                                            <input type="file" class="form-control" name="file" id="file">
                                        </div>
                                    </div>
                                    <br>
                                    <button type="submit" class="btn btn-default btn-lg btn-block">Guardar Imagen</button>
                                </form>
                                <br><br>  <br>
                    ...
                    <ul class="control-sidebar-menu">
                        <li>
                            <a href="javascript::;">
                                ...
                                <div class="menu-info">
                                    <h4 class="control-sidebar-subheading">Cerrar Secion</h4>
