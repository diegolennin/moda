			...
			<!-- Main -->
				<div id="main-wrapper">
					<div id="main" class="container">
					 <div class="col-md-9">
                    <form  id="registro" name="registro" action="../productos/nuevop.jsp" method="POST">
                        
                        <div class="form-group">
                            <input type="text" required class="form-control" id="codigo" name="codigo" placeholder="Ingrese el Codigo de Producto" onkeydown="return numeros(event)" onchange="evaluar(registro)">
                        </div>
                        <div class="form-group">
                            <input type="text" required class="form-control" id="nombre" name="nombre" placeholder="Ingrese el Nombre o Descripcion del Producto">
                        </div>
                        <div class="form-group">
                            <select autofocus required class="form-control" name="categoria" id="categoria">
                                <option value="">Selecione de tipo de categoria</option>
                        ...
                        <div class="form-group">
                            <input type="text" required class="form-control" id="maximo" name="maximo" placeholder="Ingrese la cantidad Maxima">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" id="minimo" name="minimo" placeholder="Ingrese la Cantidad Minima" onchange="validare(registro);">
                        </div>
                        <div class="form-group">
                            <input name="actual" type="text" class="form-control" id="actual" placeholder="Ingrese la Cantidad Actual" onkeydown="return numeros(event)" maxlength="15">
                        </div>
                        <div class="form-group">
                            <input name="precio" type="text" class="form-control" id="precio" placeholder="Ingrese el precio" onkeydown="return numeros(event)" maxlength="15">
                        </div>
                        <div class="form-group">
                            <input type="text" required class="form-control" id="color" name="color" placeholder="Ingrese el Color">
                        </div>
                        <div class="form-group">
                            <input type="text" required class="form-control" id="descuento" name="descuento"  placeholder="Ingrese el Descuento" onkeydown="return numeros(event)">
                        </div>
                         <div class="form-group">
                            <input type="text" required class="form-control" id="detalle" name="detalle" placeholder="Detalle nuevo Producto">
                        </div>
