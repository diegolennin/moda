        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="index2.html" class="logo">
                    ...
                    <span class="logo-lg"><b>Clientes Empresa</b></span>
                </a>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active"><a href="../administracionp/perfil.jsp"><i class="fa fa-link"></i> <span>Inicio</span></a></li> <li class="treeview">
                            <a href="../administracionp/perfil.jsp"><i class="fa fa-link"></i> <span>Perfil</span> <i class="fa fa-angle-left pull-right"></i></a>
                            <ul class="treeview-menu">
                                <li><a href="../administracionp/perfil.jsp">Modificar Perfil</a></li>
                                <li><a href="../admin/contraseña.jsp">Modificar Contraseña</a></li>
                                <li><a href="#"></a></li>
                            </ul>
                        </li>
                        <li><a href="../administracionp/foto.jsp"><i class="fa fa-link"></i> <span>Foto</span></a></li>
                        <li class="treeview">
                            <a href="#"><i class="fa fa-link"></i> <span>Promocion de Productos</span> <i class="fa fa-angle-left pull-right"></i></a>
                            <ul class="treeview-menu">
                        ...
                        <li class="treeview">
                            <a href="#"><i class="fa fa-link"></i> <span>Calatolo</span> <i class="fa fa-angle-left pull-right"></i></a>
                            <ul class="treeview-menu">
                                <li><a href="#">Todo</a> </li>
                        ...
                        <li class="treeview">
                            <a href="#"><i class="fa fa-link"></i> <span>Administradores</span> <i class="fa fa-angle-left pull-right"></i></a>
                            <ul class="treeview-menu">
                                <li><a href="#">Nuevo Administrador</a></li>
                                <li><a href="#">Modificar Administrador</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
